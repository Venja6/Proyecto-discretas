...
int main(int argc, char const *argv[]) {
    ...
    while(eleccion1 != 1 && eleccion1 != 2 && eleccion1 != 3 && eleccion1 != 4 && eleccion1 != 5 && eleccion1 != 6 && eleccion1 != 7) {
        ...
        printf("1 = grafo size 5\n");
        printf("2 = grafo size 10\n");
        printf("3 = grafo size 15\n");
        printf("4 = grafo size 20\n");
        printf("5 = Caso especial donde queda un solo vertice despues de eliminar.\n");
        printf("6 = Caso donde sea disconexo desde el inicio.\n");
        printf("7 = grafo que quiera dar, debe editar el archivo: 'grafo.txt' con los datos deseados.\n");
        scanf("%d", &eleccion1);
    }

    while(eleccion2 != 1 && eleccion2 != 2) {
        printf("Ademas puede elegir si quiere ver o no cada cambio de estado al eliminar vertices\n");
        printf("junto con los vertices eliminados al reducir la matriz.");
        printf("(Puede ser complicado de leer si se ve cada eliminacion)\n");
        printf("1 = ver eliminacion\n");
        printf("2 = no ver eliminacion\n");
        scanf("%d", &eleccion2);
    }
    ...
    if(size != 0){
        ...
        printf("No se entregaon los datos de forma correcta en el archivo leido\n");
    }
    ...
    int n = size-1;
        ...
        if(k == 1){
            printf("AAAAAAAAAAA ES DISCONEXO ELIMINANDO 1, k-conexidad o conectividad = %d\n", k);
        }
    }
    ...
    if(k == -1 && size > 2) {
        ...
        if(k == 2){
            printf("AAAAAAAAAAA ES DISCONEXO ELIMINANDO 2, k-conexidad o conectividad = %d\n", k);
        }
    }
    ...
    if(k == 3) {
        printf("AAAAAAAAAAA ES DISCONEXO ELIMINANDO 3, k-conexidad o conectividad = %d\n", k);
    }
    ...
    if(k == 4) {
        printf("AAAAAAAAAAA ES DISCONEXO ELIMINANDO 4, k-conexidad o conectividad = %d\n", k);
    }

    if(size == 5 && k == -1) {
        printf("El grafo queda con un solo vertice, tiene conectividad 4 y no puede ser mayor\n");
    }
